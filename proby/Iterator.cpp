...
//
//	template<class T, bool isConst>
//	inline Randomiterator <T, isConst> &Randomiterator<T, isConst>::operator++() {
//		++ptr;
//		return *this;
//	}
//
//	template<class T, bool isConst>
//	inline Randomiterator <T, isConst> Randomiterator<T, isConst>::operator++(int) {
...
//
//	template<class T, bool isConst>
//	inline Randomiterator <T, isConst> Randomiterator<T, isConst>::operator+=(int const &x) {
//		ptr += x;
//		return *this;
//	}
//
...
//			typename Randomiterator<T, isConst>::reference>::type
//	Randomiterator<T, isConst>::operator*() { return *ptr; }
//
//	template<class T, bool isConst>
...
//	inline bool operator==(Randomiterator < V, is_const<V>::value >
//	const& larg,
...
//
//template<class V>
//inline Randomiterator <V, is_const<V>::value>
