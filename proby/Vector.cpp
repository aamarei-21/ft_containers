...
template<class T, class Alloc>
template<class InputIterator>
inline My_class<T, Alloc>::My_class (InputIterator first,
	typename enable_if<std::__is_input_iterator<InputIterator>::value, InputIterator>::type last, const std::allocator<T>& al)
{
	_size = 0;
...
template <class T, class Alloc>
inline typename My_class<T, Alloc>::iterator My_class<T, Alloc>:: begin() { return iterator(ptr); }
...
/*==============  rbegin, rend  ================*/
template<class T, class Alloc>
inline typename My_class<T, Alloc>::reverse_iterator My_class<T, Alloc>::rbegin() { return reverse_iterator(end()); }

template<class T, class Alloc>
inline typename My_class<T, Alloc>::const_reverse_iterator My_class<T, Alloc>::rbegin() const { return end(); }

template<class T, class Alloc>
inline typename My_class<T, Alloc>::reverse_iterator My_class<T, Alloc>::rend() { return reverse_iterator(begin()); }

template<class T, class Alloc>
inline typename My_class<T, Alloc>::const_reverse_iterator My_class<T, Alloc>::rend() const { return begin(); }
